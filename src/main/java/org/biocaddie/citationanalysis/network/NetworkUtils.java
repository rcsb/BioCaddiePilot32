...
public class NetworkUtils {
	...
	public static void printNetworkSummary(Network network) {
	 ...
	 * @throws IOException
	 */
	public static void stronglyConnectedComponents(Network network, Integer startNodeId) throws IOException {
		Queue<Node> queue = new LinkedList<Node>();	    	
		int numOfVisitedNodes = 0;
		Node startNode = network.nodeMap.get(startNodeId);    	
		queue.add(startNode);  
