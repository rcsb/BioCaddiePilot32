...
public class NetworkFast {
	...
	Int2ObjectOpenHashMap<NodeFast> nodeMap = new Int2ObjectOpenHashMap<NodeFast>(30000000); //key:nodeId value:nodeName
...
class NodeFast {
	...
	Int2DoubleOpenHashMap inLinks = new Int2DoubleOpenHashMap(0);  // neighborNodeId - linkWeight, default linkWeight = 1.0
	Int2DoubleOpenHashMap outLinks = new Int2DoubleOpenHashMap(0); // neighborNodeId - linkWeight, default linkWeight = 1.0
